...
class Master_controller(threading.Thread):
    ...
    def run(self):
        ...
        while True:
            ...
            self.hall_1_target = (joystick_x - JOYSTICK_X_MIN - JOYSTICK_X_MID) / (JOYSTICK_X_MAX - JOYSTICK_X_MIN) * HALL_1_MAX
            self.hall_2_target = (joystick_y - JOYSTICK_Y_MIN - JOYSTICK_Y_MID) / (JOYSTICK_Y_MAX - JOYSTICK_Y_MIN) * HALL_2_MAX
            ...
            elif self.hall_1_counter > (self.hall_1_target + 1):
                cur_time = time.time()
            ...
            elif self.hall_2_counter > (self.hall_2_target + 1):
                cur_time = time.time()
